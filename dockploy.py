...
API_URL = "http://3.111.45.4:3000//api/project.all"
api_key = "EJvpAwqSMLYDrfwUSBKSrpftcEiqsFncTozVgMnCJxfPnRJHKrAoUmbYsDQWbChw"
app_name = "job-portal-frontend-iznhqg"
